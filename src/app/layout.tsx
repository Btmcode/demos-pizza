...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Demos Pizza · Fatih Haseki",
    description: "Günlük taze hamur, sıcak ve taze teslimat. Fatih Haseki'nin sevilen pizza adresi.",
    url: SITE_URL,
...
export const viewport: Viewport = {
  themeColor: [
    { media: "(prefers-color-scheme: light)", color: "#0d0500" },
